# Generated by Django 4.2.5 on 2023-11-28 10:05

import content.models.about_models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=content.models.about_models.department_files, verbose_name='Изображение')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workers', to='content.notarychamberdepartment', verbose_name='Подразделение')),
            ],
            options={
