# Generated by Django 4.2.5 on 2023-12-05 11:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.FileField(blank=True, null=True, upload_to=structure.models.department_docs, verbose_name='Документ')),
                ('document_ru', models.FileField(blank=True, null=True, upload_to=structure.models.department_docs, verbose_name='Документ')),
                ('document_ky', models.FileField(blank=True, null=True, upload_to=structure.models.department_docs, verbose_name='Документ')),
                ('document_en', models.FileField(blank=True, null=True, upload_to=structure.models.department_docs, verbose_name='Документ')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_ky', models.FileField(blank=True, null=True, upload_to=structure.models.department_docs, verbose_name='Документ')),
                ('document_en', models.FileField(blank=True, null=True, upload_to=structure.models.department_docs, verbose_name='Документ')),
                ('council', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='structure.notarycouncil', verbose_name='Совет')),
            ],
        ),
        migrations.CreateModel(
