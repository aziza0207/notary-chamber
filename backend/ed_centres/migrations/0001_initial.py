    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('office_ru', models.CharField(max_length=255, null=True, verbose_name='Офис')),
                ('office_ky', models.CharField(max_length=255, null=True, verbose_name='Офис')),
                ('office_en', models.CharField(max_length=255, null=True, verbose_name='Офис')),
                ('image', models.ImageField(blank=True, null=True, upload_to=ed_centres.models.center_staff, verbose_name='Изображение')),
            ],
            options={
